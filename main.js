...
document.getElementById("win-message").textContent = 'You have come to beat me??';
...
function playRound(playerHand,computerHand) {
    ...
    var gameTie = 'Its a Draw! Both choose ' + capitalize(playerHand);
...
function game(player) {
    ...
    if (playerScore == 5) {
        document.getElementById('win-message').textContent = 'Congratulations!You beat Me!!';
        document.getElementById('win-message').setAttribute('style','color: rgb(0, 138, 231);');
    }
    if (computerScore == 5) {
        document.getElementById('win-message').textContent = 'Reset again! I Win The Game!!';
        document.getElementById('win-message').setAttribute('style','color: rgb(0, 138, 231);');
    }
}  
